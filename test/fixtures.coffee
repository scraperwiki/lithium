...
exports.create_config = ->
  nock("https://api.linode.com")
  .get("/?api_key=fakeapikey&api_action=linode.config.create &LinodeID=206097&KernelID=121&Label=test&Comments=decription&DiskList=953010%2C953011&RootDeviceNum=1")
  .reply 200,
    """
    { "ERRORARRAY":[],
...
exports.avail_kernels = nock("https://api.linode.com")
  .get("/?api_key=apikey&api_action=avail.kernels&")
  .reply 200,
    """
